...
from table_utils import (
    populate_merged_row_seat_columns,
    _get_merge_row_groups,
    _merge_grouped_rows,
    merge_table_rows,
...
class TestPopulateMergedRowSeatColumns(unittest.TestCase):
    def test_kadena_1_72hr_table_1(self):
        # Load merged table
        kadena_1_72hr_table_1_merged = Table.load_state(
            "tests/unit-test-assets/populate_merged_row_seat_columns/kadena_1_72hr_table-1-merged.pkl"
        )

        # Load unmerged table
        kadena_1_72hr_table_1 = Table.load_state(
            "tests/unit-test-assets/populate_merged_row_seat_columns/kadena_1_72hr_table-1.pkl"
        )
        ...
        table_1_merge_groups = populate_merged_row_seat_columns(
            kadena_1_72hr_table_1, table_1_merge_groups
        )

        # Generate merged tables
        table_1_merged = _merge_grouped_rows(
            kadena_1_72hr_table_1, table_1_merge_groups
        )
    ...
    def test_kadena_1_72hr_table_2(self):
        # Load merged table
        kadena_1_72hr_table_2_merged = Table.load_state(
            "tests/unit-test-assets/populate_merged_row_seat_columns/kadena_1_72hr_table-2-merged.pkl"
        )

        # Load unmerged table
        kadena_1_72hr_table_2 = Table.load_state(
            "tests/unit-test-assets/populate_merged_row_seat_columns/kadena_1_72hr_table-2.pkl"
        )
        ...
        # Populate merged row seat columns
        table_2_merge_groups = populate_merged_row_seat_columns(
            kadena_1_72hr_table_2, table_2_merge_groups
        )

        # Generate merged tables
        table_2_merged = _merge_grouped_rows(
            kadena_1_72hr_table_2, table_2_merge_groups
        )
    ...
    def test_kadena_1_72hr_table_3(self):
        # Load merged table
        kadena_1_72hr_table_3_merged = Table.load_state(
            "tests/unit-test-assets/populate_merged_row_seat_columns/kadena_1_72hr_table-3-merged.pkl"
        )

        # Load unmerged table
        kadena_1_72hr_table_3 = Table.load_state(
            "tests/unit-test-assets/populate_merged_row_seat_columns/kadena_1_72hr_table-3.pkl"
        )
        ...
        # Populate merged row seat columns
        table_3_merge_groups = populate_merged_row_seat_columns(
            kadena_1_72hr_table_3, table_3_merge_groups
        )

        # Generate merged tables
        table_3_merged = _merge_grouped_rows(
            kadena_1_72hr_table_3, table_3_merge_groups
        )
...
class TestMergeTableRows(unittest.TestCase):
    def test_norfolk_1_72hr_table_1(self):
        ...
        merged_table = Table.load_state(
            "tests/unit-test-assets/merge_table_rows/norfolk_1_72hr_table-1-merged.pkl"
        )

        # Load unmerged table
        unmerged_table = Table.load_state(
            "tests/unit-test-assets/merge_table_rows/norfolk_1_72hr_table-1.pkl"
        )
    ...
    def test_kadena_2_72hr_table_2(self):
        # Load merged table
        merged_table = Table.load_state(
            "tests/unit-test-assets/merge_table_rows/kadena_2_72hr_table-2-merged.pkl"
        )

        # Load unmerged table
        unmerged_table = Table.load_state(
            "tests/unit-test-assets/merge_table_rows/kadena_2_72hr_table-2.pkl"
        )
    ...
    def test_kadena_1_72hr_table_3(self):
        # Load merged table
        merged_table = Table.load_state(
            "tests/unit-test-assets/merge_table_rows/kadena_1_72hr_table-3-merged.pkl"
        )

        # Load unmerged table
        unmerged_table = Table.load_state(
            "tests/unit-test-assets/merge_table_rows/kadena_1_72hr_table-3.pkl"
        )
    ...
    def test_hickam_1_72hr_table_1(self):
        # Load merged table
        merged_table = Table.load_state(
            "tests/unit-test-assets/merge_table_rows/hickam_1_72hr_table-1-merged.pkl"
        )

        # Load unmerged table
        unmerged_table = Table.load_state(
            "tests/unit-test-assets/merge_table_rows/hickam_1_72hr_table-1.pkl"
        )
    ...
    def test_yokota_2_72hr_table_1(self):
        # Load merged table
        merged_table = Table.load_state(
            "tests/unit-test-assets/merge_table_rows/yokota_2_72hr_table-1-merged.pkl"
        )

        # Load unmerged table
        unmerged_table = Table.load_state(
            "tests/unit-test-assets/merge_table_rows/yokota_2_72hr_table-1.pkl"
        )
...
class TestColumnInference(unittest.TestCase):
    def test_infer_roll_call_column_index(self):
        ...
        no_headers_table_col0 = Table.load_state(
            "tests/unit-test-assets/infer_roll_call_column_index/sigonella_1_72hr_table-7.pkl"
        )
        no_headers_table_col1 = Table.load_state(
            "tests/unit-test-assets/infer_roll_call_column_index/sigonella_1_72hr_table-7_rollcall_in_col_1.pkl"
        )
        no_headers_table_col2 = Table.load_state(
            "tests/unit-test-assets/infer_roll_call_column_index/sigonella_1_72hr_table-7_rollcall_in_col_2.pkl"
        )

        # Load table with column headers
        headers_table = Table.load_state(
            "tests/unit-test-assets/infer_roll_call_column_index/sigonella_1_72hr_table-8.pkl"
        )
        headers_table_col1 = Table.load_state(
            "tests/unit-test-assets/infer_roll_call_column_index/sigonella_1_72hr_table-8_rollcall_in_col_1.pkl"
        )
        headers_table_col2 = Table.load_state(
            "tests/unit-test-assets/infer_roll_call_column_index/sigonella_1_72hr_table-8_rollcall_in_col_2.pkl"
        )
        ...
        self.assertEqual(
            infer_roll_call_column_index(no_roll_call_col_headers_table), -1
        )
    ...
    def test_infer_seats_column_index(self):
        ...
        # Load tables with no column headers
        no_headers_table_col0 = Table.load_state(
            "tests/unit-test-assets/infer_seats_column_index/sigonella_1_72hr_table-7_seats_in_col_0.pkl"
        )
        no_headers_table_col1 = Table.load_state(
            "tests/unit-test-assets/infer_seats_column_index/sigonella_1_72hr_table-7_seats_in_col_1.pkl"
        )
        no_headers_table_col2 = Table.load_state(
            "tests/unit-test-assets/infer_seats_column_index/sigonella_1_72hr_table-7_seats_in_col_2.pkl"
        )

        # Load table with column headers
        headers_table_col0 = Table.load_state(
            "tests/unit-test-assets/infer_seats_column_index/sigonella_1_72hr_table-8_seats_in_col_0.pkl"
        )
        headers_table_col1 = Table.load_state(
            "tests/unit-test-assets/infer_seats_column_index/sigonella_1_72hr_table-8_seats_in_col_1.pkl"
        )
        headers_table_col2 = Table.load_state(
            "tests/unit-test-assets/infer_seats_column_index/sigonella_1_72hr_table-8_seats_in_col_2.pkl"
        )
    ...
    def test_infer_destinations_column_index(self):
        ...
        # Load tables with no column headers
        no_headers_table_col0 = Table.load_state(
            "tests/unit-test-assets/infer_destinations_column_index/sigonella_1_72hr_table-7_destinations_in_col_0.pkl"
        )
        no_headers_table_col1 = Table.load_state(
            "tests/unit-test-assets/infer_destinations_column_index/sigonella_1_72hr_table-7_destinations_in_col_1.pkl"
        )
        no_headers_table_col2 = Table.load_state(
            "tests/unit-test-assets/infer_destinations_column_index/sigonella_1_72hr_table-7_destinations_in_col_2.pkl"
        )

        # Load table with column headers
        headers_table_col0 = Table.load_state(
            "tests/unit-test-assets/infer_destinations_column_index/sigonella_1_72hr_table-8_destinations_in_col_0.pkl"
        )
        headers_table_col1 = Table.load_state(
            "tests/unit-test-assets/infer_destinations_column_index/sigonella_1_72hr_table-8_destinations_in_col_1.pkl"
        )
        headers_table_col2 = Table.load_state(
            "tests/unit-test-assets/infer_destinations_column_index/sigonella_1_72hr_table-8_destinations_in_col_2.pkl"
        )
        ...
        self.assertEqual(
            infer_destinations_column_index(no_destinations_col_table_col0), -1
        )
        self.assertEqual(
            infer_destinations_column_index(no_destinations_col_table_col1), -1
        )
        self.assertEqual(
            infer_destinations_column_index(no_destinations_col_table_col2), -1
        )
        self.assertEqual(
            infer_destinations_column_index(no_destinations_coll_headers_table), -1
        )
