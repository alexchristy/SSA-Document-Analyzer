...
from souda_bay_1_72hr_textract_response import souda_bay_1_72hr_textract_response as current_textract_response
...
def lambda_handler(event, context):
    ...
    table_pkl_path = 'tests/table-objects/souda_bay_1_72hr_table-3.pkl'
